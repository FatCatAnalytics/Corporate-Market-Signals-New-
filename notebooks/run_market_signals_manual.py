...
dbutils.widgets.text("pipeline_dir", "/Workspace/Users/aetingu@gmail.com/Corporate-Market-Signals-New-")
dbutils.widgets.text("input_csv", "/Workspace/Users/aetingu@gmail.com/Corporate-Market-Signals-New-/corporate_100.csv")
...
dbutils.widgets.text("classifier_endpoint", "databricks-qwen3-next-80b-a3b-instruct")
...
print(f"Prescreener: {PRESCREENER_ENDPOINT}")
